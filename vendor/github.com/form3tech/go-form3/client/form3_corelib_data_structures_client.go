...
import (
	...
	"github.com/form3tech/go-form3/client/billing_api"
	"github.com/form3tech/go-form3/client/system"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Form3CorelibDataStructures {
	...
	cli.BillingAPI = billing_api.New(transport, formats)
...
type Form3CorelibDataStructures struct {
	BillingAPI billing_api.ClientService
...
func (c *Form3CorelibDataStructures) SetTransport(transport runtime.ClientTransport) {
	...
	c.BillingAPI.SetTransport(transport)
