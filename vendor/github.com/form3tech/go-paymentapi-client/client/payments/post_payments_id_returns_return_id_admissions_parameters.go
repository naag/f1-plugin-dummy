...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the post payments ID returns return ID admissions params
func (o *PostPaymentsIDReturnsReturnIDAdmissionsParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *PostPaymentsIDReturnsReturnIDAdmissionsParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the post payments ID returns return ID admissions params
func (o *PostPaymentsIDReturnsReturnIDAdmissionsParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the post payments ID returns return ID admissions params
func (o *PostPaymentsIDReturnsReturnIDAdmissionsParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *PostPaymentsIDReturnsReturnIDAdmissionsParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the post payments ID returns return ID admissions params
func (o *PostPaymentsIDReturnsReturnIDAdmissionsParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
