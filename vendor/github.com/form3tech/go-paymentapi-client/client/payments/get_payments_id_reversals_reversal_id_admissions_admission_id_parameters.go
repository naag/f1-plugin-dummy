...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID reversals reversal ID admissions admission ID params
func (o *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID reversals reversal ID admissions admission ID params
func (o *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the get payments ID reversals reversal ID admissions admission ID params
func (o *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the get payments ID reversals reversal ID admissions admission ID params
func (o *GetPaymentsIDReversalsReversalIDAdmissionsAdmissionIDParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
