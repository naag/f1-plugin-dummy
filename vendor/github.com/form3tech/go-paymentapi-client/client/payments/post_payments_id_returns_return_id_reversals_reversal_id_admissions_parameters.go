...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the post payments ID returns return ID reversals reversal ID admissions params
func (o *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the post payments ID returns return ID reversals reversal ID admissions params
func (o *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the post payments ID returns return ID reversals reversal ID admissions params
func (o *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the post payments ID returns return ID reversals reversal ID admissions params
func (o *PostPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
