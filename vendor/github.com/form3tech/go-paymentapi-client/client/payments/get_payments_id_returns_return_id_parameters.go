...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID returns return ID params
func (o *GetPaymentsIDReturnsReturnIDParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *GetPaymentsIDReturnsReturnIDParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID returns return ID params
func (o *GetPaymentsIDReturnsReturnIDParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the get payments ID returns return ID params
func (o *GetPaymentsIDReturnsReturnIDParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *GetPaymentsIDReturnsReturnIDParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the get payments ID returns return ID params
func (o *GetPaymentsIDReturnsReturnIDParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
