...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID returns return ID reversals reversal ID params
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the get payments ID returns return ID reversals reversal ID params
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the get payments ID returns return ID reversals reversal ID params
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the get payments ID returns return ID reversals reversal ID params
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
