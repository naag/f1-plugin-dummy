...
// WithXForm3TransactionTime adds the xForm3TransactionTime to the patch limits ID params
func (o *PatchLimitsIDParams) WithXForm3TransactionTime(xForm3TransactionTime *string) *PatchLimitsIDParams {
	o.SetXForm3TransactionTime(xForm3TransactionTime)
	return o
}

// SetXForm3TransactionTime adds the xForm3TransactionTime to the patch limits ID params
func (o *PatchLimitsIDParams) SetXForm3TransactionTime(xForm3TransactionTime *string) {
	o.XForm3TransactionTime = xForm3TransactionTime
}

// WithXForm3CorrelationID adds the xForm3CorrelationID to the patch limits ID params
func (o *PatchLimitsIDParams) WithXForm3CorrelationID(xForm3CorrelationID *string) *PatchLimitsIDParams {
	o.SetXForm3CorrelationID(xForm3CorrelationID)
	return o
}

// SetXForm3CorrelationID adds the xForm3CorrelationId to the patch limits ID params
func (o *PatchLimitsIDParams) SetXForm3CorrelationID(xForm3CorrelationID *string) {
