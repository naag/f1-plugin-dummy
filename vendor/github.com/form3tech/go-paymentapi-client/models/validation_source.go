...
const (
	...
	// ValidationSourceSepasctGateway captures enum value "sepasct_gateway"
	ValidationSourceSepasctGateway ValidationSource = "sepasct_gateway"

	// ValidationSourceLhvGateway captures enum value "lhv_gateway"
	ValidationSourceLhvGateway ValidationSource = "lhv_gateway"

	// ValidationSourceFpsGateway captures enum value "fps_gateway"
	ValidationSourceFpsGateway ValidationSource = "fps_gateway"

	// ValidationSourceGocardlessGateway captures enum value "gocardless_gateway"
	ValidationSourceGocardlessGateway ValidationSource = "gocardless_gateway"

	// ValidationSourceEburyGateway captures enum value "ebury_gateway"
	ValidationSourceEburyGateway ValidationSource = "ebury_gateway"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["payment_api","payport_interface","starling_gateway","bacs_gateway","sepainstant_gateway","sepasct_gateway","lhv_gateway","fps_gateway","gocardless_gateway","ebury_gateway"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
