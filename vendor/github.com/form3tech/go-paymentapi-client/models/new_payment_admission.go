...
func (m *NewPaymentAdmissionAttributes) validateStatus(formats strfmt.Registry) error {
...
func (m *NewPaymentAdmissionAttributes) validateStatusReason(formats strfmt.Registry) error {
